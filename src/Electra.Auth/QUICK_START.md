...
```bash
cd D:\proj\microbians\microbians.io\Electra
...
{
    // Arrange
    var user = new ElectraUser { Email = "test@example.com" };
...
4. ✅ Add to Program.cs (AddElectraAuthentication + InitializeJwtSigningKeysAsync)
