...
#### RefreshToken Entity
**File**: `Electra.Models/Entities/RefreshToken.cs`
...
**File**: `Electra.Models/Entities/JwtSigningKey.cs`
...
**File**: `Electra.Persistence/ElectraDbContext.cs`
...
Updated `AddElectraAuthentication()` to register:
...
src/Electra.Models/Entities/
├── RefreshToken.cs                   (NEW)
└── JwtSigningKey.cs                  (NEW)

src/Electra.Persistence/
└── ElectraDbContext.cs               (Updated)
```
...
| `Auth:Jwt:Issuer` | "Electra" | JWT issuer |
| `Auth:Jwt:Audience` | "ElectraClients" | JWT audience |
