...
10. **`Models/Entities/RefreshToken.cs`** (moved from Electra.Auth to Electra.Models)
11. **`Models/Entities/JwtSigningKey.cs`** (moved from Electra.Auth to Electra.Models)
...
+ global using Electra.Auth.Services;
+ global using Electra.Auth.Models;
...
+ Updated AddElectraAuthentication():
...
### 4. **`Electra.Persistence/ElectraDbContext.cs`**
```diff
+ Added imports:
...
### 5. **`Electra.Models/Entities/RefreshToken.cs`** (moved file)
```diff
~ Namespace changed from:
  - Electra.Auth.Models → Electra.Models.Entities
...
### 6. **`Electra.Models/Entities/JwtSigningKey.cs`** (moved file)
```diff
~ Namespace changed from:
  - Electra.Auth.Models → Electra.Models.Entities
