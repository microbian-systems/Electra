...
public class JwtTokenService : IJwtTokenService
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var token = new JwtSecurityToken(
            issuer: _config["Auth:Jwt:Issuer"] ?? "Electra",
            audience: _config["Auth:Jwt:Audience"] ?? "ElectraClients",
            claims: claims,
        ...
        CancellationToken cancellationToken = default)
    {
        try
        {
            ...
            var validationParameters = new TokenValidationParameters
            {
                ...
                ValidateIssuer = true,
                ValidIssuer = _config["Auth:Jwt:Issuer"] ?? "Electra",
                ValidateAudience = true,
                ValidAudience = _config["Auth:Jwt:Audience"] ?? "ElectraClients",
