...
public class SmartKernelFactory
{
    ...
    private readonly AeroDbContext _dbContext;
    ...
    public SmartKernelFactory(IAeroUnitOfWork uow, IEncryptor encryptor, IOptionsMonitor<UserSettings> userSettings, ILogger<SmartKernelFactory> log, IConfiguration config, AeroDbContext dbContext)
    {
        _logger = log;
        this.uow = uow;
