...
namespace Electra.Persistence
{
    ...
    public class GenericMartenRepository<T, TKey> : GenericRepository<T, TKey>, IGenericMartenRepository<T, TKey> where T : IEntity<TKey>, new() where TKey : IEquatable<TKey>
    {
        ...
        public override async Task<IEnumerable<T>> GetAllAsync() => await session.Query<T>().ToListAsync(CancellationToken.None);
        ...
        public override IEnumerable<T> Find(Expression<Func<T, bool>> strategy) => FindAsync(strategy).GetAwaiter().GetResult();
