...
/// <summary>
/// Specifies optional parameters for timeline endpoints (user tweets and mentions).
/// </summary>
public class TimelineOptions
{
    /// <summary>
    /// The maximum number of results to return per page.
    /// Valid values: 5-100. Default: 10.
    /// </summary>
    ...
    /// <summary>
    /// Allows you to specify whether to include or exclude specific types of tweets.
    /// Example: "retweets,replies" to exclude both.
    /// </summary>
    ...
    /// <summary>
    /// Validates the timeline options.
    /// </summary>
    ...
    public void Validate()
    {
        ...
        {
            if (MaxResults.Value < 5 || MaxResults.Value > 100)
            {
                throw new ArgumentException("MaxResults must be between 5 and 100", nameof(MaxResults));
            }
        }
