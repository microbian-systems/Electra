...
public class BlogService(IBlogRepository repository, ILogger<BlogService> logger) : IBlogService
{
    ...
    public async Task<PagedResult<Entities.BlogEntry>> GetPaginatedBlogsAsync(int pageNumber, int pageSize, bool publishedOnly = true) => await repository.GetPaginatedBlogsAsync(pageNumber, pageSize, publishedOnly);
    ...
    public async Task<PagedResult<Entities.BlogEntry>> SearchBlogsAsync(string searchTerm, int pageNumber, int pageSize) => await repository.SearchBlogsAsync(searchTerm, pageNumber, pageSize);

    public async Task<PagedResult<Entities.BlogEntry>> GetBlogsByTagAsync(string tag, int pageNumber, int pageSize) => await repository.GetBlogsByTagAsync(tag, pageNumber, pageSize);
    ...
    public async Task<string> GetRawMarkdownAsync(Entities.BlogEntry blog) => await repository.GetContentAsMarkdownAsync(blog);
    ...
    public async Task<PagedResult<Entities.BlogEntry>> GetBlogsByAuthorAsync(string author, int pageNumber, int pageSize) => await repository.GetBlogsByAuthorAsync(author, pageNumber, pageSize);
