...
using Aero.Cms.Areas.Blog.Models;
...
namespace Aero.Cms.Areas.Blog.Controllers;

[Area("Blog")]
[AllowAnonymous]
[Route("blog")]
public class BlogController(IBlogService blogService, ILogger<AeroWebBaseController> log) : AeroWebBaseController(log)
{
    [HttpGet]
