...
public class RavenDbPersistenceTests : RavenDbTestBase
{
    ...
    public async Task UnitOfWork_Should_Persist_User_Added_Through_Repository()
    {
        ...
        var persistedUser = await session.LoadAsync<ElectraUser>(user.Id);
    ...
    {
        // Arrange
        var user1 = new ElectraUser { Id = "users/u1", UserName = "user1", Email = "u1@ex.com", FirstName = "f1", LastName = "l1", CreatedBy = "s" };
        var user2 = new ElectraUser { Id = "users/u2", UserName = "user2", Email = "u2@ex.com", FirstName = "f2", LastName = "l2", CreatedBy = "s" };
        ...
        using var session = DocumentStore.OpenAsyncSession();
        var count = await session.Query<ElectraUser>().CountAsync();
        count.Should().Be(2);
    }
    ...
    {
        // Arrange
        var user1 = new ElectraUser { Id = "users/f1", UserName = "find1", Email = "f1@ex.com", FirstName = "Match", LastName = "User", CreatedBy = "s" };
        var user2 = new ElectraUser { Id = "users/f2", UserName = "find2", Email = "f2@ex.com", FirstName = "Other", LastName = "User", CreatedBy = "s" };
        await _unitOfWork.Users.InsertAsync(user1);
        await _unitOfWork.Users.InsertAsync(user2);
        await _unitOfWork.SaveChangesAsync();
    ...
    {
        // Arrange
        var user = new ElectraUser { Id = "users/ex", UserName = "exists", Email = "ex@ex.com", FirstName = "Ex", LastName = "User", CreatedBy = "s" };
        await _unitOfWork.Users.InsertAsync(user);
        await _unitOfWork.SaveChangesAsync();
