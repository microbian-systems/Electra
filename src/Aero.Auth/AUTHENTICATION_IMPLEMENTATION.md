...
dotnet ef migrations add AddAuthenticationTokens --context AeroDbContext
dotnet ef database update --context AeroDbContext
```

Or from the project root:

```bash
dotnet ef migrations add AddAuthenticationTokens -p src/Aero.Persistence -s src/Aero.Auth
```
