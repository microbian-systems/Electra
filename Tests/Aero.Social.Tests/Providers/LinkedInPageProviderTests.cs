...
public class LinkedInPageProviderTests : ProviderTestBase
{
    private readonly Mock<ILogger<LinkedInPageProvider>> _loggerMock = new();

    private LinkedInPageProvider CreateProvider()
    {
    ...
    public void Provider_ShouldHaveCorrectIdentifier()
    {
        ...
        provider.Identifier.ShouldBe("linkedin-page");
        provider.Name.ShouldBe("LinkedIn Page");
        provider.IsBetweenSteps.ShouldBeTrue();
        provider.RefreshWait.ShouldBeTrue();
